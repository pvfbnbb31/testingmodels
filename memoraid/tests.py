...
from memoraid.models import Memoraid
from memoraid.views import MemoraidModelForm
...
import validators
'''
class MemoraidMethodTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        ...
        future_question = Memoraid(pub_date=time)
    ...
    def test_was_published_recently_with_old_question(self):
        ...
        """
        time = timezone.now() - datetime.timedelta(days=30)
        old_question = Memoraid(pub_date=time)
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        recent_question = Memoraid(pub_date=time)
        self.assertEqual(recent_question.was_published_recently(), True)


def create_memoraid(memoraid_text, days):
    """
    ...
    return Memoraid.objects.create(question_text=memoraid_text,pub_date=time)

class MemoraidViewTests(TestCase):
    ...
    def test_index_view_with_no_questions(self):
        ...
        self.assertQuerysetEqual(response.context['latest_qmemoraid_list'], [])
    ...
    def test_index_view_with_a_past_question(self):
        ...
        index page
        """
        create_memoraid(memoraid_text="Past question.", days=-30)
        response = self.client.get(reverse('memoraid:index'))
    ...
    def test_index_view_with_a_future_question(self):
        ...
        the index page.
        """
        create_memoraid(question_text="Future question.", days=30)
        response = self.client.get(reverse('polls:index'))
